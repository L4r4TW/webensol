...
const services = {
  "crm-erp": {
    ...
    description: "Custom systems to manage your customer relationships and business operations efficiently.",
  ...
  webshop: {
    ...
    description: "Custom e-commerce solutions designed to enhance your online sales.",
    image: "/placeholder.svg?height=400&width=800",
    features: [
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-zinc-500 md:text-xl">{service.description}</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-start">
            <div className="space-y-4">
              ...
              <p className="text-zinc-500 md:text-lg">
                Our {service.title.toLowerCase()} solutions include the following features:
              </p>
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl">Benefits</h2>
              <p className="text-zinc-500 md:text-lg">
                By implementing our {service.title.toLowerCase()} solutions, you'll benefit from:
              </p>
              <ul className="space-y-2">
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-zinc-500 md:text-lg">
                Contact us today to discuss your {service.title.toLowerCase()} project requirements.
              </p>
            </div>
